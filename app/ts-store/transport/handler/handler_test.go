...
func (e *MockMEngine) DbPTRef(db string, ptId uint32) error {
	return nil
}
...
func (e *MockMEngine) DbPTUnref(db string, ptId uint32) {}
...
func (e *MockMEngineError) DbPTRef(db string, ptId uint32) error {
	if db == "db1" {
...
func (e *MockMEngineError) DbPTUnref(db string, ptId uint32) {}
