...
func (s *Storage) RegisterOnPTLoaded(id uint64, f engine.PtLoadFunc) {
	s.engine.RegisterOnPTLoaded(id, f)
}

func (s *Storage) UninstallOnPTLoaded(id uint64) {
	s.engine.UninstallOnPTLoaded(id)
}
